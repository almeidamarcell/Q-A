...
var lwRTE = function(textarea, options) {
    ...
    this.controls = { rte: rte_toolbar, html: '' };
...
var rte_toolbar = {
    ...
    link: { exec: function() {
        ...
        panel.append('\<p><label>URL</label><input type="text" id="url" size="30" value=""></p>\
                                    <div class="clear"></div>\
                                    ...
                                    <div class="clear"></div>\
                                    <p class="submit clearfix"><button id="ok">Ok</button><button id="cancel">Cancel</button></p>'
                                    ).show();
