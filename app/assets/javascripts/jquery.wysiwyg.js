...
(function($) {
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        init: function(element, options) {
            ...
            var newX = element.width || options.width || element.clientWidth;
            var newY = element.height || options.height || element.clientHeight;
            ...
            if (element.nodeName.toLowerCase() == 'textarea') {
                ...
                .attr('frameBorder', '0').attr('frameMargin', '0').attr('framePadding', '0');
